...
sms.forEach(function(d) {

if (d.getAttribute("address").match(num)) 
	...
	tab.push({
		...
		body : d.getAttribute("body"),
	date: new Date(parseFloat(d.getAttribute("date"))),
	hour: new Date(parseFloat(d.getAttribute("date"))).getHours(),
	month: new Date(parseFloat(d.getAttribute("date"))).getMonth(),
	day: new Date(parseFloat(d.getAttribute("date"))).getDate(),
	year: new Date(parseFloat(d.getAttribute("date"))).getYear(),
	length: d.getAttribute("body").length,
...
metrics_hours.forEach(function(d, i) {
